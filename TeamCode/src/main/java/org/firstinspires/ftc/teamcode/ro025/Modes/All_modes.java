...
import org.firstinspires.ftc.teamcode.ro025.Outtake.Init_pos;
        ...
        public static void intake_sample_init(){
            ...
            switch(whatToRetract_intake_sample_init){
                case CLAW:
                    ...
                    break;
                case EXTENSION:
                    if(Extension.getInstance().extindere_left.getCurrentPosition() != extensionTarget/**trebuie aproximat**/)
                    ...
                    break;
                case PIVOT:
                    if(Pivot.getInstance().motorPivot.getCurrentPosition() != pivotTarget/**trebuie aproximat**/)
                ...
                case YES:
                    switch(whatToDo_intake_sample_loop){
                        ...
                        case GET_PIVOT_UP:
                            ...
                            if(Pivot.getInstance().motorPivot.getCurrentPosition() != Pivot.TICKS_FOR_PARALLEL/**trebuie aproximat**/) {
